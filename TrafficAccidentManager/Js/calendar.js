...
function writeIframe()
{
    ...
    "    <table id=tableDay height=120 width=140 border=0 cellspacing=1 cellpadding=0>";
        ...
        " </td>"
         ...
         " type=button value='╳' onclick='parent.hiddenCalendar()'></td></tr></table>"+
...
function WebCalendar() //初始化日历的设置
{
    ...
    this.day        = new Array(37);            //定义日历展示用的数组
    this.dayObj     = new Array(37);            //定义日期展示控件数组
...
function appendZero(n){return((n).substr((n).length-2));}//日期自动补零程序
...
function writeCalendar() //对日历显示的数据的处理程序
{
    ...
    for(var i=0; i<37; i++)    //这个循环是根据源数组写到日历里显示
    {
